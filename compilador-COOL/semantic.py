from yacc import Class, Method, Id, Assign, Dispatch, StaticDispatch, If, While, \
    Block, Let, Case, New, Isvoid, Not, Complement, Int, \
    Bool, Str, Plus, Sub, Mult, Div, Lt, Le, Eq, \
    Attr, TypeAction, Self
...
#         significa que nós podemos ter métodos com o mesmo nome que variáveis."""
...
#         elif isinstance(feature, Method):   # varre os métodos e checa os parâmetros formais
...
#                 variable_scopes[formal[0]] = formal[1]  # talvez mudar
...
#         ret_type = lowest_common_ancestor(then_type, else_type)  # função a criar 
...
#     """ Aplica as regras de herança através do gráfico de classes"""
...
# # acho q é bom colocar depois do type cheking
...
# def type_check(cl):
#     """Confere se o tipo inferido coincide com o tipo declarado"""
#     for feature in cl.feature_list:
#         if isinstance(feature, Attr):
#             if feature.type == "SELF_TYPE":
#                 realtype = cl.name
